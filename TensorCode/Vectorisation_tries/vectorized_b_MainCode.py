...
import TensorCode.vectorized_b_ks as ks

from math import pi


@tf.function(input_signature=[tf.TensorSpec(shape=(28,), dtype=tf.float64)])
...
def evolve_HW(tau, n, m, r, v, newton_solution):
    ...
    concatenated = tf.concat(
        [tau, mij, r0, vv0, newton_solution], axis=2)
    ...
    concatenated = tf.reshape(concatenated, (-1, 28))
