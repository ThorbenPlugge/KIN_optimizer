...
process_result(output_path, output_filename, maj_param, log_error=False, filter_outliers=False)
process_result(output_path, output_filename, maj_param, log_error=True, filter_outliers=False)
