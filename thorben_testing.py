...
def plotLossFunction():
    ...
    mass_range = []
    num_points = 100 # Number of points in the mass range
    ...
    print("Starting the loop over all combinations of masses...")
    # Loop over all combinations of masses
    for i in tqdm.tqdm(range(M1.shape[0])):
